...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/homepage3',
          asyncParams: {
            'cartitems': getDoc(['cartitems'], CartitemsRecord.fromSnapshot),
          },
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'homepage3')
              : Homepage3Widget(
        ...
        FFRoute(
          name: 'Checkout7',
          path: '/checkout7',
          builder: (context, params) => Checkout7Widget(),
        ),
        FFRoute(
          name: 'payment',
          path: '/payment',
        ...
        FFRoute(
          ...
          path: '/activity',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'lastpage')
              : LastpageWidget(),
        ),
        FFRoute(
          name: 'search',
        ...
        FFRoute(
          ...
          asyncParams: {
            'productselection':
                getDoc(['cartitems'], CartitemsRecord.fromSnapshot),
          },
        ...
        FFRoute(
          name: 'Product1fal',
          path: '/product1fal',
          builder: (context, params) => Product1falWidget(),
        ),
        FFRoute(
          name: 'Checkout2',
          path: '/checkout2',
        ...
        FFRoute(
          name: 'payment1Copy',
          path: '/payment1Copy',
          builder: (context, params) => Payment1CopyWidget(),
        ),
        FFRoute(
          name: 'Product1falCopy',
          path: '/product1falCopy',
          builder: (context, params) => Product1falCopyWidget(),
        ),
        FFRoute(
          name: 'login',
          path: '/login',
