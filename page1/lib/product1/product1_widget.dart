...
class Product1Widget extends StatefulWidget {
  ...
  final CartitemsRecord? productselection;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CartRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CartRecord> product1CartRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final product1CartRecord = product1CartRecordList.isNotEmpty
            ? product1CartRecordList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
                      ...
                      children: [
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            await itemdetailsRecordReference.set({
                              ...createItemdetailsRecordData(
                                ...
                                cartref: product1CartRecord?.reference,
                                cartitemref: widget.productselection?.reference,
                                itemphoto:
                                    widget.productselection?.productphoto,
                              ),
                              'modifiers': widget.productselection?.modifiers,
                              'modifiers1': widget.productselection?.modifiers,
                            });
                            _model.itemincart =
                            ...
                            await product1CartRecord!.reference.update({
                              ...createCartRecordData(
                                cartactive: true,
                              ),
                              'itemcount': FieldValue.increment(
                                  _model.countControllerValue!),
                              'subtotal': FieldValue.increment(functions
                                  .subtotal(_model.countControllerValue!,
